...
class Schema__Comprehend__Batch__Detect_Key_Phrases(Type_Safe):
    """
    Response from BatchDetectKeyPhrases operation.

    Contains key phrase extraction results for successfully processed documents
    and error information for failed documents.
    """
    result_list : List[Schema__Comprehend__Batch_Item__Detect_Key_Phrases] # Successfully processed documents
