...
from osbot_aws.aws.s3.S3__Minio                             import DEFAULT__MINIO__SERVER, DEFAULT__MINIO__ACCESS_KEY, DEFAULT__MINIO__SECRET_KEY
from osbot_utils.utils.Objects                              import __, dict_to_obj
from osbot_aws.AWS_Config                                   import aws_config
from osbot_aws.aws.s3.S3__DB_Base import S3_DB_BASE__BUCKET_NAME__PREFIX, S3_DB_BASE__BUCKET_NAME__SUFFIX, S3__DB_Base, ENV_NAME__USE_MINIO_AS_S3
from osbot_aws.testing.TestCase__S3_Minio__Temp_S3_Bucket   import TestCase__S3_Minio__Temp_S3_Bucket


class test_S3__DB__Base(TestCase__S3_Minio__Temp_S3_Bucket):

    def test___init__(self):
        with self.s3_db_base as _:
            assert type(_) is S3__DB_Base
            assert _.obj() == __(use_minio                      = True,
